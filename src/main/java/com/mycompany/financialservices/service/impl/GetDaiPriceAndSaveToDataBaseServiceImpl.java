...
@Service
@Log4j2
public class GetDaiPriceAndSaveToDataBaseServiceImpl implements GetCryptoPriceAndSaveToDataBaseService {
    ...
    public void execute() throws Exception {
        log.info("se ejecuto el metodo priceDai");
        priceCryptoService.getDaiPrice().map(cryptoHistoryRepository::save).subscribe();
    }
}
